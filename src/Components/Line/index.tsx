            ...
            <>
              <Circle
                cx={scaleTime()
                  ...
                  .range([10, GRAPH_WIDTH - 10])(
                    new Date(latestDataPoint.date),
                  )}
                cy={scaleLinear()
                  .domain([
                    Math.min(...data.map((val) => val.value)),
                    Math.max(...data.map((val) => val.value)),
                  ])
                  .range([GRAPH_HEIGHT, 35])(latestDataPoint.value)}
                r={4}
                color={Theme.colors.pink}
              />
              <Text
                ...
                y={
                  scaleLinear()
                    ...
                    .range([GRAPH_HEIGHT, 20])(latestDataPoint.value) - 10
                }
